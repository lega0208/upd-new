export const filterDimensions = {
  ...
  device: {
    description:
      'Filter results against the specified device type. Supported values in expression: "desktop", "mobile", "tablet"',
  },
  page: { description: 'Filter against the specified URI string.' },
  query: { description: 'Filter against the specified query string.' },
  searchAppearance: {
    description:
      'Filter against a specific search result feature. To see a list of available values, run a query grouped by "searchAppearance".',
  },
};
...
export const filterOperator = {
  ...
  includingRegex: {
    description: 'An RE2 syntax regular expression that must be matched.',
  },
  excludingRegex: {
    description: 'An RE2 syntax regular expression that must not be matched.',
  },
};
...
export const aggregationType = {
  ...
  byProperty: {
    description:
      'Aggregate values by property. Not supported for type=discover or type=googleNews',
  },
};
...
export const type = {
  ...
  image: {
    description: 'Search results from the "Image" tab in Google Search.',
  },
