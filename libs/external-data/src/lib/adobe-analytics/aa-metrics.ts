export const metricIds = {
    ...
    'metrics/evar111instances': {
        title: 'SRT Donn�es de visite - Sondage sur la r�ussite de t�ches du GC (v111) Instances',
    ...
    'metrics/evar112instances': {
        title: 'TSS Visit Data - Survey Referrer / SRT Donn�es de visite - R�f�rent du Sondage (v112) Instances',
    ...
    'metrics/evar123instances': {
        title: 'SRT Donn�es du sondage - Sondage sur la r�ussite de t�ches du GC (v123) Instances',
    ...
    'metrics/evar124instances': {
        title: 'TSS Survey Data - Sampling / SRT Donn�es du sondage - �chantillonnage (v124) Instances',
    ...
    'metrics/evar125instances': {
        title: 'TSS Survey Data - Survey Referrer / SRT Donn�es du sondage - R�f�rent du Sondage (v125) Instances',
    ...
    'metrics/evar129instances': {
        title: 'UTM Source/Medium � External Campaigns (7 day expiry) (v129) Instances',
    ...
    'metrics/evar130instances': {
        title: 'UTM Source/Medium/Content � External Campaigns (7 day expiry) (v130) Instances',
    ...
    'metrics/evar29instances': {
        title: 'UTM Source/Medium � External Campaigns (visit expiry) (v29) Instances',
        description: 'Combination of the utm source and medium parameters for an external campaign. To be used with External Campaign Click (e31).\r\n',
    },
    ...
    'metrics/evar30instances': {
        title: 'UTM Source/Medium/Content � External Campaigns (visit expiry) (v30) Instances',
        description: 'Combination of the utm source, medium and content parameters for an external campaign. To be used with External Campaign Click (e31).\r\n',
    },
    ...
    'metrics/evar80instances': {
        title: 'What Was Wrong - Did You Find What You Were Looking For (v80) Instances',
    ...
    'metrics/evar96instances': {
        title: 'TSS Visit Data - Sampling / SRT Donn�es de visite - �chantillonnage (v96) Instances',
    ...
    'metrics/event110': {
        title: 'Visit Data - GC Task Success Survey Completed / Donn�es de visite - Sondage sur la r�ussite de t�ches du GC termin� (e110)',
    ...
    'metrics/event120': {
        title: 'Survey Data - GC Task Success Survey Completed / Donn�es du sondage - Sondage sur la r�ussite de t�ches du GC termin� (e120)',
        description: 'When the GC Task Success Survey is successfully submitted (offline data).',
    },
    'metrics/event20': {
    ...
    'metrics/event71': {
        ...
        description: 'When the \'Share this page\' or \'Share\' button is clicked activating the social share widget.',
    },
    'metrics/event72': {
    ...
    'metrics/event75': {
        ...
        description: 'When the \'Report a Problem\' submit button is clicked and the form is submitted.\r\n',
    },
    'metrics/event76': {
    ...
    'metrics/event83': {
        ...
        description: 'When the \'Did You Find What You Were Looking For?\' yes button is clicked.\r\n',
    },
    'metrics/event84': {
        title: 'No Click - Did You Find What You Were Looking For (e84)',
        description: 'When the \'Did You Find What You Were Looking For?\' no button is clicked.\r\n',
    },
    'metrics/event85': {
        title: 'Submit Click - Did You Find What You Were Looking For (e85)',
        description: 'When the \'Did You Find What You Were Looking For?\' submit button is clicked.\r\n',
    },
    'metrics/event9': {
