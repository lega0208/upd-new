...
import { ComboBubbleLineChartComponent } from './combo-bubble-line-chart.component';

describe('ComboBubbleLineChartComponent', () => {
  let component: ComboBubbleLineChartComponent;
  let fixture: ComponentFixture<ComboBubbleLineChartComponent>;
  let XDOMAIN: number[],
    YDOMAIN: number[],
    BUBBLESERIES: any[],
    LINESERIES: any[];
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ComboBubbleLineChartComponent);
